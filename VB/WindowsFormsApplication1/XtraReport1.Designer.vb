Namespace WindowsFormsApplication1
	Partial Public Class XtraReport1
		...
		Private Sub InitializeComponent()
			...
			Me.parameterMultiGroupField = New DevExpress.XtraReports.Parameters.Parameter()
			...
			' xrTableCell4
			' 
			Me.xrTableCell4.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Products.SupplierID")})
			...
			tableInfo2.SelectedColumns.AddRange(New DevExpress.DataAccess.Sql.ColumnInfo() { columnInfo6, columnInfo7, columnInfo8, columnInfo9, columnInfo10, columnInfo11})
			...
			' 
			Me.parameterMultiGroupField.Description = "Group By"
			staticListLookUpSettings1.LookUpValues.Add(New DevExpress.XtraReports.Parameters.LookUpValue("CategoryID", Nothing))
			staticListLookUpSettings1.LookUpValues.Add(New DevExpress.XtraReports.Parameters.LookUpValue("SupplierID", Nothing))
			staticListLookUpSettings1.LookUpValues.Add(New DevExpress.XtraReports.Parameters.LookUpValue("ProductName", Nothing))
			staticListLookUpSettings1.LookUpValues.Add(New DevExpress.XtraReports.Parameters.LookUpValue("UnitPrice", Nothing))
			Me.parameterMultiGroupField.LookUpSettings = staticListLookUpSettings1
			Me.parameterMultiGroupField.MultiValue = True
			Me.parameterMultiGroupField.Name = "parameterMultiGroupField"
			' 
			' XtraReport1
			' 
			...
			Me.Parameters.AddRange(New DevExpress.XtraReports.Parameters.Parameter() { Me.parameterMultiGroupField})
...
'			Me.BeforePrint += New System.Drawing.Printing.PrintEventHandler(Me.XtraReport1_BeforePrint)
		...
		Private parameterMultiGroupField As DevExpress.XtraReports.Parameters.Parameter
	End Class
End Namespace
